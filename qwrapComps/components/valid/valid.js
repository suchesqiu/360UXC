	...
	*/
	...
	var Utils = Valid.Utils = {
		...
		getCalendarImg: (function() {
			...
			return function() {
				return calendarImg = calendarImg || createElement('<img src="http://p19.qhimg.com/d/_open360crmcalendar.gif" align="absMiddle" class="calendar-hdl-img" style="cursor:pointer">');
			};
		}()),
		/** 
		 * 用日历浮动层来输入一个日期。
		...
		pickDate: function(el) {
			if (QW.Calendar) {
				...
				var calendarJsUrl = Valid.validPath + "calendar.js?v="+new Date().getTime(); //to get the calendarUrl Url.
