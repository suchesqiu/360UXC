    ...
    var _logic =
    {
        ...
        , initMonthDate:
            function( _dateObj ){
                ...
                var ipt = UXC.Calendar.lastIpt, currentcanselecte = true;
                if( ipt.is('[currentcanselecte]') ) currentcanselecte = parseBool( ipt.attr('currentcanselecte') );

                if( _dateObj.maxvalue && !currentcanselecte ){
    ...
    var _logic = {
        ...
        , updateBody:
            function( _dateObj ){
                ...
                var ipt = UXC.Calendar.lastIpt, currentcanselecte = parseBool( ipt.attr('currentcanselecte') );
